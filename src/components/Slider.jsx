...
const Slider = () => {
    ...
    return (
      ...
      <div className='App lg:absolute lg:top-1/3  lg:left-96 mt-12 lg:mt-0  z-30'>
      <h1  className='lg:text-7xl text-3xl font-bold heading text-orange-700  md:text-center ml-4 lg:ml-0'>
      Explore the World with {' '}
        ...
        <p className='lg:text-lg text-sm text-center  lg:left-96 left-10 text-white font-mono lg:absolute lg:top-1/2 top-[500px] z-30 opacity-90 bg-black p-6 rounded-md bg-opacity-50  '>
